    ...
    <div class="container mt-m-3 p-3" id="admin-login">
            ...
            if (empty($_POST['username']) || empty($_POST['password'])) {
                ...
                if (lauth_recaptcha_is_enabled()) {
                    ...
                    if (is_array($verify)) {
                        ...
                        if ($_POST['username'] != LAUTH_ADMIN_USERNAME ||  $_POST['password'] != LAUTH_ADMIN_PASSWORD) {
        ...
        <form action="" method="post" class="form">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="username" title="Tên tài khoản" required  placeholder="tên tài khoản...">
                <small class="form-small-text">Tài khoản của admin</small>
            </div>
            <div class="form-group">
                <label for="password">Mật khẩu</label>
                <input class="form-control" type="password" name="password" title="Mật khẩu" required placeholder="mật khẩu...">
            </div>
